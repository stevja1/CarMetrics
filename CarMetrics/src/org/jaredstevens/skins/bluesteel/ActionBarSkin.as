...
package org.jaredstevens.skins.bluesteel
{
...
{
	[Embed(source="/assets/images/ActionBar.png")]
...
//            addChild(border);
		...
		if( this.backgroundBitmap == null )
			this.backgroundBitmap = new backgroundImg().bitmapData;
    ...
    override protected function drawBackground(unscaledWidth:Number, unscaledHeight:Number):void
    {
		...
		// Scale the action bar to whatever the width of the screen is
		var matrix:Matrix = new Matrix();
		matrix.scale(unscaledWidth / this.backgroundBitmap.width, unscaledHeight / this.backgroundBitmap.height);
		graphics.beginBitmapFill( this.backgroundBitmap, matrix, false, false );
...
{
	private var titleDisplayImage:Image;
    private var titleDisplay:StyleableTextField;
    private var titleDisplayShadow:StyleableTextField;
    private var title:String;
    private var titleChanged:Boolean;
	
	[Embed(source="/assets/images/ActionsHeader.png")]
	private var actionsHeader:Class; 
	private var actionsBitmap:BitmapData;

	[Embed(source="/assets/images/AddVehicleHeader.png")]
	private var addVehicleHeader:Class;
	private var addVehicleBitmap:BitmapData;
	
	[Embed(source="/assets/images/EditVehicleHeader.png")]
	private var editVehicleHeader:Class;
	private var editVehicleBitmap:BitmapData;
	
	[Embed(source="/assets/images/MaintenanceHeader.png")]
	private var maintenanceHeader:Class; 
	private var maintenanceBitmap:BitmapData;
	
	[Embed(source="/assets/images/PitStopHeader.png")]
	private var pitStopHeader:Class;
	private var pitStopBitmap:BitmapData;

	[Embed(source="/assets/images/VehiclesHeader.png")]
	private var vehiclesHeader:Class;
	private var vehiclesBitmap:BitmapData;
    ...
    override protected function createChildren():void
    {
		...
		titleDisplayImage = new Image();
		titleDisplayImage.addEventListener(FlexEvent.VALUE_COMMIT, titleDisplay_valueCommitHandler );
		addChild(titleDisplayImage);
		
		if( this.addVehicleBitmap == null ) this.addVehicleBitmap = new addVehicleHeader().bitmapData;
		if( this.actionsBitmap == null ) this.actionsBitmap = new actionsHeader().bitmapData;
		if( this.editVehicleBitmap == null ) this.editVehicleBitmap = new editVehicleHeader().bitmapData;
		if( this.maintenanceBitmap == null ) this.maintenanceBitmap = new maintenanceHeader().bitmapData;
		if( this.pitStopBitmap == null ) this.pitStopBitmap = new pitStopHeader().bitmapData;
		if( this.vehiclesBitmap == null ) this.vehiclesBitmap = new vehiclesHeader().bitmapData;
...
//        addChild(titleDisplay);
    ...
    override protected function commitProperties():void
    {
        ...
        if (titleChanged)
        {
			...
			{
				case "Actions":
					this.titleDisplayImage.source = this.actionsBitmap;
					break;
				case "Add Vehicle":
					this.titleDisplayImage.source = this.addVehicleBitmap;
					break;
				case "Edit Vehicle":
					this.titleDisplayImage.source = this.editVehicleBitmap;
					break;
				case "Maintenance":
					this.titleDisplayImage.source = this.maintenanceBitmap;
					break;
				case "Pit Stop":
					this.titleDisplayImage.source = this.pitStopBitmap;
					break;
				case "Vehicles":
					this.titleDisplayImage.source = this.vehiclesBitmap;
					break;
				default:
					break;
			}
...
//            titleDisplay.text = title;
        ...
        measuredWidth = titleDisplayImage.getPreferredBoundsWidth();
        
        // tightTextHeight
        measuredHeight = titleDisplayImage.getPreferredBoundsHeight();
    }
...
//        var tightY:Number = (unscaledHeight - tightHeight) / 2;
        var tightHeight:Number = titleDisplayImage.getPreferredBoundsHeight();
        var tightY:Number = (unscaledHeight - tightHeight) / 2;
...
//        titleDisplay.setLayoutBoundsPosition(0, (unscaledHeight - tightHeight) / 2);
        titleDisplayImage.setLayoutBoundsSize(unscaledWidth, tightHeight);
        titleDisplayImage.setLayoutBoundsPosition(0, (unscaledHeight - tightHeight) / 2);
